  ...
  function () {
    ...
    _createClass(SimpleBar, [{
      ...
      value: function recalculate() {
        ...
        this.axis.x.isOverflowing = (this.scrollbarWidth ? this.contentEl.scrollWidth : this.contentEl.scrollWidth - this.minScrollbarWidth) > this.contentEl.clientWidth;
        this.axis.y.isOverflowing = (this.scrollbarWidth ? this.contentEl.scrollHeight : this.contentEl.scrollHeight - this.minScrollbarWidth) > this.contentEl.clientHeight; // Set isOverflowing to false if user explicitely set hidden overflow
        ...
        this.hideNativeScrollbar(); // Determine placeholder size

        this.placeholderEl.style.width = isWidthAuto ? "".concat(this.resizeWrapperEl.clientWidth, "px") : 'auto';
        this.placeholderEl.style.height = "".concat(this.resizeWrapperEl.clientHeight, "px");
      }
      /**
